...
class Waypoints(GenericSR):
    ...
    def __multiple_waypoints(self):
        ...
        # TODO: Scale number of waypoints with size of network
        # TODO: Set waypoints till it doesnt get better
        # TODO: Instead of MLU optimise percentage of overloaded links
    ...
    def solve(self) -> dict:
        ...
        loads, waypoints, objective = self.__multiple_waypoints()
        pt_duration = time.process_time() - pt_start
        t_duration = time.time() - t_start

        solution = {
            "objective": objective,
            "percentage_of_overloaded_links": self.percentage_of_overloaded_links(),
    ...
    def percentage_of_overloaded_links(self) -> float:
        overloaded_links = 0
        for (u, v), lu in self.__loads.items():
            if lu > 1:
                overloaded_links += 1
